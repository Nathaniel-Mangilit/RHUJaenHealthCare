...
if($action == "add"){
		if(isset($_FILES['file']['name'])){
		   // file name
		   $filename   = "news-".uniqid() . "-" . time(); // 5dab1961e93a7-1571494241
		   // Location
		...
		$sql = "DELETE FROM news WHERE id_news=".$_POST['id'];
...
if(isset($_FILES['file']['name'])){
		...
		}else
		{
			...
			`event_name`='".$_POST['event_name']."',
			`location`='".$_POST['location']."',
			`details`='".$_POST['details']."' WHERE eventId = ".$_POST['id'];
